        ...
        LocationListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeAutocompleteFragment = (PlaceAutocompleteFragment)getFragmentManager().findFragmentById(R.id.locationSearchBar);
        ...
        placeAutocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onError(Status status) {
                Toast.makeText(MapManager.this, ""+status.toString(), Toast.LENGTH_SHORT).show();
            }
        });
